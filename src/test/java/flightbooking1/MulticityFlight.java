...
public class MulticityFlight {
	WebDriver driver;
	  ...
	  public void fbpage1() throws Exception{
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//li[contains(@data-cy,'mulitiCityTrip')]")).click();
			Thread.sleep(1000);
			
	  }
	
	
	  @Test (priority=2, description="Checking From Location 1")
	  ...
	  @Test (priority=3, description="Checking To Location 1")
	  ...
	  @Test (priority=4, description="Checking Departing Date 1")
	  public void fbpage4() throws Exception{
			driver.findElement(By.xpath("//div[@aria-label='Wed Oct 13 2021']")).click();
			Thread.sleep(1000);
	  }
	  
	  @Test (priority=5, description="Checking To Location 2")
	  public void fbpage5() throws Exception{
		  driver.findElement(By.xpath("//div[contains(@class,'fsw')]//div[2]//div[2]")).click();
	  ...
	  @Test (priority=6, description="Checking Departing 2 Date")
	  public void fbpage6() throws Exception{
			driver.findElement(By.xpath("//div[@aria-label='Wed Oct 27 2021']//p[contains(text(),'27')]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//a[normalize-space()='Search']")).click();
			Thread.sleep(3000);
	  }
	  
	  @Test (priority=7, description="Selecting Flight")
	  public void fbpage7() throws Exception{
		  ...
		  try{
			  driver.findElement(By.id("bookbutton-RKEY:e006bf2a-fe4f-45bf-9f59-ef05346b76c3:43_0")).click();  //continue button click
				Thread.sleep(1000);
		  }
		  catch(Exception NoSuchElementException) 
		  {
			  try{
				  driver.findElement(By.xpath("//button[@class='btn fli_primary_btn text-uppercase ']")).click(); //view prices>BOOK NOW click
				  Thread.sleep(1000);
			  }
	  ...
	  @Test (priority=8, description="Switching to new window")
...
@Test (priority=9, description="giving credentials and clicking continue")
public void fbpage9() throws Exception{
  try {
